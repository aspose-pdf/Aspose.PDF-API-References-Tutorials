...
-  Ο`Flags` η ιδιοκτησία περιλαμβάνει`AnnotationFlags.Print` για να διασφαλίσετε ότι ο σχολιασμός είναι ορατός κατά την εκτύπωση του εγγράφου και`AnnotationFlags.NoView` για να το κάνει αόρατο κατά την κανονική προβολή.
