...
R : Non, les boutons radio d'un groupe sont conçus pour s'exclure mutuellement. Vous ne pouvez sélectionner qu'un seul bouton radio à la fois dans un groupe, et en sélectionner un désélectionnera automatiquement tout bouton radio précédemment sélectionné dans le même groupe.

#### Q : Comment récupérer le bouton radio sélectionné dans un groupe à l'aide d'Aspose.PDF pour .NET ?

 R : Pour récupérer le bouton radio sélectionné dans un groupe, vous pouvez utiliser le`Selected` propriété de la`RadioButtonField`classe. Il renverra l'index du bouton radio sélectionné dans le groupe.
