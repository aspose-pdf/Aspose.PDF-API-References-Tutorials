---
title: Establecer privilegios
linktitle: Establecer privilegios
second_title: Referencia de API de Aspose.PDF para .NET
description: Establezca fácilmente privilegios de acceso para sus archivos PDF con Aspose.PDF para .NET.
type: docs
weight: 100
url: /es/net/programming-with-security-and-signatures/set-privileges/
---

A menudo es necesario establecer privilegios de acceso específicos para archivos PDF. Con Aspose.PDF para .NET, puede configurar fácilmente los privilegios de acceso utilizando el siguiente código fuente:
