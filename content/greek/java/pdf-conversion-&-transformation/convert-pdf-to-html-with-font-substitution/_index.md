...
## Προσαρμογή της μετατροπής
 ...
 Μπορείτε να προσαρμόσετε περαιτέρω την έξοδο HTML προσαρμόζοντας το`HtmlSaveOptions` παραμέτρους. Αυτό σας επιτρέπει να ελέγχετε διάφορες πτυχές της μετατροπής, όπως η συμπίεση εικόνας και η μορφοποίηση κειμένου.
