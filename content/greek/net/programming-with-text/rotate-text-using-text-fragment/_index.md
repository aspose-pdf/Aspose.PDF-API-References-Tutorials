...
## Βήμα 6: Δημιουργήστε ένα TextBuilder και προσθέστε τμήματα κειμένου
 ...
 Δημιουργία α`TextBuilder` αντικείμενο χρησιμοποιώντας το`pdfPage` και προσθέστε τα τμήματα κειμένου στη σελίδα PDF:
...
5.  Δημιουργία α`TextBuilder`αντικείμενο και προσθέστε τα τμήματα κειμένου στη σελίδα PDF.
