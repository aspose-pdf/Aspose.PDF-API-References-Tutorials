...
#### Вопрос: Как определить XForm с помощью Aspose.PDF?
 ...
 О: Чтобы создать XForm, используйте команду`XForm.CreateNewForm` метод и добавьте его в`Resources.Forms` коллекция конкретной страницы. Затем вы можете добавить содержимое в XForm.`Contents` свойство.
