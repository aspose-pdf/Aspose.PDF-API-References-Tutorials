...
Có, bạn có thể tùy chỉnh giao diện của tài liệu PDF bằng Aspose.PDF for Java. Bạn có thể thiết lập kích thước trang, lề, phông chữ, màu sắc, v.v. để tạo PDF phù hợp với phong cách mong muốn của bạn.
