---
title: Text und Bild als Absatz
linktitle: Text und Bild als Absatz
second_title: Aspose.PDF für .NET API-Referenz
description: Erfahren Sie, wie Sie mit Aspose.PDF für .NET Text und ein Bild als Inline-Absätze in ein PDF-Dokument einfügen.
type: docs
weight: 530
url: /de/net/programming-with-text/text-and-image-as-paragraph/
---

In diesem Tutorial wird erläutert, wie Sie mit Aspose.PDF für .NET Text und ein Bild als Inline-Absätze in ein PDF-Dokument einfügen. Der bereitgestellte C#-Quellcode demonstriert den Prozess Schritt für Schritt.
