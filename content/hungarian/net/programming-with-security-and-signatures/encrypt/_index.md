...
## 2. lépés: Állítsa be a dokumentumok mappa elérési útját
 ...
 Ebben a lépésben meg kell adnia a titkosítandó PDF-fájlt tartalmazó mappa elérési útját. Cserélje ki`"YOUR DOCUMENTS DIRECTORY"` a következő kódban a dokumentummappa tényleges elérési útjával:
