...
О: Функция «Автоматическая подгонка под размер окна» при создании PDF-файла гарантирует, что макет PDF-документа автоматически подстраивается под размер окна программы чтения PDF-файлов, используемого пользователем. Это обеспечивает лучший просмотр и гарантирует, что контент идеально вписывается в доступную область просмотра.
