...
ج: الغرض من هذا البرنامج التعليمي هو إرشادك خلال عملية رسم الخطوط باستخدام Aspose.PDF for .NET. ستتعلم كيفية إنشاء خطوط على صفحة PDF وتخصيص مظهرها.
...
#### س: كيف أقوم بإنشاء أسطر على صفحة PDF؟

ج: يوضح البرنامج التعليمي إنشاء كائن رسم بأبعاد الصفحة ثم إضافة كائنات Line إليه. قم بتعديل إحداثيات وخصائص كائنات الخط لإنشاء الخطوط المطلوبة.
...
ج: بعد إضافة كائن الرسم البياني بكائنات Line إلى الصفحة ، يمكنك حفظ مستند PDF الناتج باستخدام ملف`pDoc.Save(dataDir + "DrawingLine_out.pdf");` سطر في شفرة المصدر المقدمة.
