...
Документы PDF часто содержат сложный контент, такой как таблицы, изображения и текст. Чтобы обеспечить доступность этих документов для всех пользователей, важно использовать правильную маркировку тегами. Пользовательские имена тегов позволяют вам определять осмысленные и описательные имена для элементов в вашем PDF, что упрощает интерпретацию контента для программ чтения с экрана и других вспомогательных технологий.
