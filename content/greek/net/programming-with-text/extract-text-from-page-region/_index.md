...
## Βήμα 5: Εξαγωγή κειμένου από μια περιοχή σελίδας
 Δημιουργία α`TextAbsorber` αντικείμενο για εξαγωγή κειμένου από το έγγραφο. Ρυθμίστε το`TextSearchOptions` για να περιορίσετε την αναζήτηση σε μια συγκεκριμένη περιοχή σελίδας που ορίζεται από ένα ορθογώνιο.
...
## Βήμα 7: Αποθηκεύστε το εξαγόμενο κείμενο
 Δημιουργία α`TextWriter` και ανοίξτε το αρχείο στο οποίο θέλετε να αποθηκεύσετε το εξαγόμενο κείμενο. Γράψτε το εξαγόμενο κείμενο στο αρχείο και κλείστε τη ροή.
