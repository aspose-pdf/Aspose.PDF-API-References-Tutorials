...
description: Μάθετε πώς να περιστρέφετε κείμενο χρησιμοποιώντας παράγραφο κειμένου και πρόγραμμα δημιουργίας σε αρχείο PDF χρησιμοποιώντας το Aspose.PDF για .NET.
type: docs
weight: 410
...
## Βήμα 5: Δημιουργήστε και περιστρέψτε παραγράφους κειμένου
 ...
 Δημιουργία α`for` βρόχο για τη δημιουργία πολλαπλών παραγράφων κειμένου με διαφορετικές περιστροφές:
...
## Βήμα 8: Δημιουργήστε ένα TextBuilder και προσθέστε την παράγραφο
 ...
 Δημιουργία α`TextBuilder` αντικείμενο χρησιμοποιώντας το`pdfPage` και προσθέστε την παράγραφο κειμένου στη σελίδα PDF:
...
#### Ε: Πώς μπορώ να προσαρμόσω τη μορφοποίηση των τμημάτων κειμένου στις παραγράφους κειμένου;
 ...
 Α: Μπορείτε να προσαρμόσετε τη μορφοποίηση των τμημάτων κειμένου ορίζοντας διάφορες ιδιότητες του`TextState` εντός του καθενός`TextFragment` αντικείμενο. Ιδιότητες όπως το μέγεθος γραμματοσειράς, ο τύπος γραμματοσειράς, τα χρώματα προσκηνίου και φόντου και η υπογράμμιση μπορούν να προσαρμοστούν για να επιτευχθεί το επιθυμητό οπτικό αποτέλεσμα.
