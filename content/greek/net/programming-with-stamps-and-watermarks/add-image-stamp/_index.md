...
### Πώς μπορώ να περιστρέψω μια σφραγίδα εικόνας;  
 Μπορείτε να ρυθμίσετε το`Rotate` ιδιοκτησία του`ImageStamp` αντικείμενο για να περιστρέψετε την εικόνα στην επιθυμητή γωνία. Οι επιλογές περιλαμβάνουν`Rotation.on90`, `Rotation.on180`κ.λπ.
