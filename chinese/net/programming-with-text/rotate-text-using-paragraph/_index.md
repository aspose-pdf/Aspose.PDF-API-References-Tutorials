...
本教程解释了如何使用 Aspose.PDF for .NET 来使用段落旋转文本。提供的 C# 源代码逐步演示了该过程。
...
创建一个`TextParagraph`对象并设置它在页面上的位置：
...
创建多个`TextFragment`对象并设置它们的文本和属性：
...
恭喜！您已经成功学习了如何使用 Aspose.PDF for .NET 在 PDF 文档中使用段落来旋转文本。本教程提供了从创建文档到保存修改后版本的分步指南。您现在可以将此代码合并到您自己的 C# 项目中，以操作 PDF 文件中的文本旋转。