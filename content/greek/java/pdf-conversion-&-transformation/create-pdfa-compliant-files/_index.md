...
Το Aspose.PDF για Java προσφέρει ένα ευρύ φάσμα δυνατοτήτων για την προσαρμογή των εγγράφων PDF σας, συμπεριλαμβανομένης της προσθήκης κεφαλίδων, υποσέλιδων, υδατογραφημάτων και άλλων. Εξερευνήστε το[απόδειξη με έγγραφα](https://reference.aspose.com/pdf/java/) για λεπτομερείς πληροφορίες σχετικά με τις επιλογές προσαρμογής.
