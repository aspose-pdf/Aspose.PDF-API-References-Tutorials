...
description: .NET के लिए Aspose.PDF का उपयोग करके PDF फ़ाइल में किसी विशिष्ट पृष्ठ से टेक्स्ट निकालने का तरीका जानें।
type: docs
weight: 200
...
#### प्रश्न: मैं किसी विशिष्ट पृष्ठ से टेक्स्ट कैसे निकालूं?
 ...
 ए: चरण 5 में ए बनाना शामिल है`TextAbsorber` पीडीएफ दस्तावेज़ से पाठ निकालने के लिए ऑब्जेक्ट। फिर आप वांछित पृष्ठ के लिए अवशोषक को इसके माध्यम से एक्सेस करके स्वीकार करेंगे`Pages` का संग्रह`pdfDocument`.
