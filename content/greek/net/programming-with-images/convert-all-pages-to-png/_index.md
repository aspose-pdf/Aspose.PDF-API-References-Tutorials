...
```
 ...
 Ο`Resolution` Η class μας επιτρέπει να καθορίσουμε την ποιότητα της εικόνας. Το 300 DPI θεωρείται συνήθως μια καλή ισορροπία μεταξύ ποιότητας και μεγέθους αρχείου.
