---
title: Pulsante radio con opzioni
linktitle: Pulsante radio con opzioni
...
Aggiungi una pagina al documento e crea una tabella per contenere le opzioni del pulsante di opzione:
...
Crea un'istanza di un oggetto RadioButtonField per rappresentare il pulsante di opzione:
...
Personalizza le opzioni del pulsante di opzione impostando attributi come bordo, colore del testo e testo della didascalia:
...
// Ripeti gli stessi passaggi per opt2 e opt3
...
### Esempio di codice sorgente per Radio Button With Options utilizzando Aspose.Words per .NET 
```csharp
try
{
...
Congratulazioni! Hai aggiunto correttamente un pulsante di opzione con opzioni a un documento PDF utilizzando Aspose.PDF per .NET. Ora puoi utilizzare questo metodo per creare moduli interattivi nei tuoi documenti PDF.