...
## Βήμα 5: Δημιουργήστε την παράγραφο κειμένου
 ...
 Δημιουργία α`TextParagraph` αντικείμενο και ορίστε τη θέση του στη σελίδα:
...
1.  Δημιουργία α`TextParagraph` αντικείμενο.
...
4.  Δημιουργία α`TextBuilder` αντικείμενο και προσάρτηση της παραγράφου κειμένου σε μια συγκεκριμένη σελίδα PDF.
