...
## Set the path of the directory where the document is located.

```csharp
string dataDir = "YOUR DOCUMENT DIRECTORY";
```

## Open the PDF document that contains the annotation whose resource you want to get.
...
## Add the annotation to a page in the document.
...
## Get the rendition of the action.
...
## Print the name of the rendition and the rendition operation.
