...
Давайте начнем с создания простого PDF-документа и добавления в него текста. Вот пример кода, с которого можно начать:
