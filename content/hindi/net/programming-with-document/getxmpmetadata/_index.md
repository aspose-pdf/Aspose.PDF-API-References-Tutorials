---
title: एक्सएमपी मेटाडेटा प्राप्त करें
linktitle: एक्सएमपी मेटाडेटा प्राप्त करें
...
एक बार जब आप .NET के लिए Aspose.PDF इंस्टॉल कर लेते हैं और अपने .NET प्रोजेक्ट में DLL का संदर्भ जोड़ लेते हैं, तो आप इसका उपयोग शुरू कर सकते हैं`GetXmpMetadata` पीडीएफ दस्तावेज़ से एक्सएमपी मेटाडेटा निकालने की सुविधा।
...
```
 ...
 उपरोक्त कोड में, प्रतिस्थापित करें`"YOUR DOCUMENT DIRECTORY"` उस निर्देशिका के पथ के साथ जहां आपका पीडीएफ दस्तावेज़ स्थित है। यह कोड पीडीएफ दस्तावेज़ को एक में लोड करेगा`Document` ऑब्जेक्ट, जिसका उपयोग आप XMP मेटाडेटा निकालने के लिए कर सकते हैं।
...
```
 ...
 उपरोक्त कोड में,`xmp:CreateDate`, `xmp:Nickname` , और`xmp:CustomProperty` एक्सएमपी मेटाडेटा गुणों के उदाहरण हैं जिन्हें आप पीडीएफ दस्तावेज़ से निकाल सकते हैं। आप इन प्रॉपर्टी नामों को किसी अन्य XMP मेटाडेटा प्रॉपर्टी के नाम से बदल सकते हैं जिसे आप निकालना चाहते हैं।

### .NET के लिए Aspose.PDF का उपयोग करके XMP मेटाडेटा प्राप्त करने के लिए उदाहरण स्रोत कोड

 इसका उपयोग करके पीडीएफ दस्तावेज़ से एक्सएमपी मेटाडेटा निकालने के लिए पूर्ण स्रोत कोड यहां दिया गया है`GetXmpMetadata` .NET के लिए Aspose.PDF की सुविधा:
...
#### प्रश्न: GetXmpMetadata सुविधा का उपयोग करके किस प्रकार की जानकारी निकाली जा सकती है?
 ...
 उ: GetXmpMetadata सुविधा डेवलपर्स को PDF दस्तावेज़ से विभिन्न XMP मेटाडेटा गुण निकालने की अनुमति देती है। एक्सएमपी मेटाडेटा गुणों के कुछ उदाहरण जिन्हें निकाला जा सकता है`xmp:CreateDate`, `xmp:Nickname` , और`xmp:CustomProperty`. डेवलपर्स इन संपत्तियों तक पहुंच सकते हैं और आवश्यकतानुसार अपने अनुप्रयोगों में उनका उपयोग कर सकते हैं।
