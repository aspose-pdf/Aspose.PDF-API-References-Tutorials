---
title: Suchen Sie nach regulären Ausdrücken
linktitle: Suchen Sie nach regulären Ausdrücken
second_title: Aspose.PDF für .NET API-Referenz
description: Erfahren Sie, wie Sie mit Aspose.PDF für .NET Text mithilfe regulärer Ausdrücke in einem PDF-Dokument suchen und abrufen.
type: docs
weight: 440
url: /de/net/programming-with-text/search-regular-expression/
---

In diesem Tutorial wird erläutert, wie Sie mit Aspose.PDF für .NET Text suchen und abrufen, der einem regulären Ausdruck in einem PDF-Dokument entspricht. Der bereitgestellte C#-Quellcode demonstriert den Prozess Schritt für Schritt.
