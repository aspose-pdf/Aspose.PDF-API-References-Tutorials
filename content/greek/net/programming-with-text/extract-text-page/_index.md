...
## Βήμα 5: Εξαγωγή κειμένου από μια συγκεκριμένη σελίδα
 Δημιουργία α`TextAbsorber` αντικείμενο για εξαγωγή κειμένου από το έγγραφο. Αποδεχτείτε τον απορροφητήρα για την επιθυμητή σελίδα, προσεγγίζοντάς τον μέσω του`Pages` συλλογή των`pdfDocument`.
