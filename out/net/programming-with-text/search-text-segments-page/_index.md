...
description: Learn how to search for text segments on a page in a PDF document and retrieve their properties using Aspose.PDF for .NET.
type: docs
weight: 470
url: /content/net/programming-with-text/search-text-segments-page/
---

This tutorial explains how to use Aspose.PDF for .NET to search for specific text segments on a page of a PDF document and retrieve their properties. The provided C# source code demonstrates the process step by step.
