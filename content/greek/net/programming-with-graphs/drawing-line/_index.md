...
1.  Aspose.PDF για .NET: Πρέπει να έχετε εγκατεστημένο το Aspose.PDF για .NET. Μπορείτε να το κατεβάσετε από το[Aspose ιστότοπο](https://releases.aspose.com/pdf/net/).
