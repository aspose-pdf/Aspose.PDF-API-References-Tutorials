...
创建一个`TextFragmentAbsorber`对象以查找输入搜索短语的所有实例。接受 PDF 文档所有页面的吸收器以提取文本片段。
...
### 使用 Aspose.PDF for .NET 全部替换文本的示例源代码 
```csharp
//文档目录的路径。
string dataDir = "YOUR DOCUMENT DIRECTORY";
//打开文档
...
在本教程中，您学习了如何使用 .NET 的 Aspose.PDF 库替换 PDF 文档中的所有文本。按照分步指南并执行提供的 C# 代码，您可以加载 PDF 文档、搜索所需的文本、替换它并保存修改后的 PDF。