---
title: Extraer texto todo
linktitle: Extraer texto todo
second_title: Referencia de API de Aspose.PDF para .NET
description: Aprenda a extraer todo el texto de un documento PDF con Aspose.PDF para .NET.
type: docs
weight: 180
url: /es/net/programming-with-text/extract-text-all/
---

Este tutorial lo guiará a través del proceso de extracción de todo el texto de un documento PDF usando Aspose.PDF para .NET. El código fuente de C# proporcionado demuestra los pasos necesarios.
...
## Paso 5: extrae todo el texto
 Crear un`TextAbsorber` objeto para extraer texto del documento. Luego, acepte el absorbedor para todas las páginas.
...
### Ejemplo de código fuente para Extraer texto todo usando Aspose.PDF para .NET 
```csharp
