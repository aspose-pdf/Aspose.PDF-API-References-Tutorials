---
title: Récupérer les informations de la pièce jointe
linktitle: Récupérer les informations de la pièce jointe
second_title: Aspose.PDF API de traitement PDF Java
description: Découvrez comment récupérer des pièces jointes PDF en Java à l'aide d'Aspose.PDF. Guide étape par étape avec des exemples de code pour gérer les pièces jointes de documents PDF.
type: docs
weight: 12
...
2.  Aspose.PDF pour la bibliothèque Java. Vous pouvez le télécharger depuis[ici](https://releases.aspose.com/pdf/java/).
...
### Comment puis-je extraire les pièces jointes d'un PDF ?
 ...
 Pour extraire des pièces jointes, vous pouvez utiliser le`attachment.getData()` méthode pour obtenir le contenu de la pièce jointe, puis l'enregistrer dans un fichier local.
...
### Comment puis-je ajouter de nouvelles pièces jointes à un PDF ?
 ...
 Vous pouvez ajouter des pièces jointes à un document PDF à l'aide de l'outil`AttachmentCollection.add()`méthode. Fournissez simplement le nom, la description et le contenu de la pièce jointe, et elle sera ajoutée au document.