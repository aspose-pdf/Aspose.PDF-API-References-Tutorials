---
title: Appliquer le style de numérotation
linktitle: Appliquer le style de numérotation
second_title: Référence de l'API Aspose.PDF pour .NET
description: Apprenez à appliquer un style de numérotation aux en-têtes d'un document PDF à l'aide d'Aspose.PDF pour .NET. Guide étape par étape.
type: docs
weight: 10
url: /fr/net/programming-with-headings/apply-number-style/
---
Dans ce didacticiel, nous vous guiderons pas à pas dans le code source C # suivant pour appliquer le style de numérotation à l'aide de Aspose.PDF pour .NET.
