...
### Jak dynamicky změním šířku čáry?  
 Můžete upravit`LineWidth` majetek z`LineInfo` objekt před převodem souřadnic na body.

### Je možné zprůhlednit poznámku inkoustem?  
 Ano, můžete upravit`Opacity` majetek z`InkAnnotation` objekt, aby byl průhledný.
