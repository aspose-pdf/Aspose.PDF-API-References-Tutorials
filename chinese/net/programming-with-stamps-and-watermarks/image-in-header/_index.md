...
上面的代码从“aspose-logo.jpg”文件创建一个图像缓冲区并设置其属性，例如上边距、水平和垂直对齐方式。然后图像戳将作为页眉部分添加到 PDF 文档的所有页面。

## 第 4 步：保存修改后的 PDF 文档

在标题部分添加图像后，我们可以保存修改后的 PDF 文档。就是这样：
...
恭喜！您已经学习了如何使用 Aspose.PDF for .NET 在 PDF 文档的页眉部分添加图像。您现在可以通过添加图像来自定义 PDF 文档的标题。
