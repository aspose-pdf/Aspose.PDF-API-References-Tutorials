---
title: زر الاختيار مع الخيارات
linktitle: زر الاختيار مع الخيارات
second_title: Aspose.PDF لمرجع .NET API
description: أضف بسهولة زر اختيار مع خيارات إلى مستند PDF باستخدام Aspose.PDF for .NET.
type: docs
weight: 230
url: /ar/net/programming-with-forms/radio-button-with-options/
---

في هذا البرنامج التعليمي ، سنوضح لك كيفية إضافة زر اختيار مع خيارات إلى مستند PDF باستخدام Aspose.PDF for .NET. سنشرح كود المصدر C # خطوة بخطوة لإرشادك خلال هذه العملية.
...
## الخطوة 3: أضف الصفحة والجدول

أضف صفحة إلى المستند وأنشئ جدولًا للاحتفاظ بخيارات زر الاختيار:
...
تخصيص خيارات زر الاختيار عن طريق تعيين سمات مثل الحدود ولون النص ونص التسمية التوضيحية:
...
// كرر نفس الخطوات لـ opt2 و opt3
...
تهنئة ! لقد نجحت في إضافة زر اختيار مع خيارات إلى مستند PDF باستخدام Aspose.PDF for .NET. يمكنك الآن استخدام هذه الطريقة لإنشاء نماذج تفاعلية في مستندات PDF الخاصة بك.