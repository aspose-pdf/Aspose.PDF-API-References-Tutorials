...
## Passaggio 3: converti ogni pagina in PNG
 ...
 In questo passaggio, esamineremo ciascuna pagina del documento PDF e le convertiremo in singoli file PNG. Useremo a`for` loop per scorrere tutte le pagine.
