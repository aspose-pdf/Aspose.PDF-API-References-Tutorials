...
## Βήμα 3: Αναζήτηση και αντικατάσταση κειμένου
 ...
 Δημιουργώ ένα`TextFragmentAbsorber` αντικείμενο για να βρείτε όλες τις παρουσίες της φράσης αναζήτησης εισόδου. Αποδεχτείτε τον απορροφητή για όλες τις σελίδες του εγγράφου PDF για να εξαγάγετε τα τμήματα κειμένου.
...
2.  Δημιουργώ ένα`TextFragmentAbsorber` αντικείμενο για να βρείτε όλες τις παρουσίες της φράσης αναζήτησης εισόδου. Αποδεχτείτε τον απορροφητή για όλες τις σελίδες του εγγράφου PDF για να εξαγάγετε τα τμήματα κειμένου.
...
#### Ε: Μπορώ να αντικαταστήσω κείμενο βάσει αναζήτησης με διάκριση πεζών-κεφαλαίων;
 ...
 Α: Ναι, μπορείτε να τροποποιήσετε το`TextFragmentAbsorber` αναζήτηση κειμένου για να πραγματοποιήσετε αναζήτηση με διάκριση πεζών-κεφαλαίων. Απλώς δώστε το ακριβές κείμενο που θέλετε να αναζητήσετε και ο απορροφητής θα ταιριάζει ανάλογα.
