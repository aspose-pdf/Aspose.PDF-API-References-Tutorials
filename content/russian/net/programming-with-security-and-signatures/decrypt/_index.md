...
#### Вопрос: Как сохранить расшифрованный PDF-документ?
 ...
 О: После расшифровки PDF воспользуйтесь`Save` метод на`Document` объект для сохранения обновленного PDF-документа. Укажите путь к выходному файлу, в котором будет сохранен расшифрованный PDF-файл.
