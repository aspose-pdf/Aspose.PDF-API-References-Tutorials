...
#### В: Поддерживает ли Aspose.PDF для .NET преобразование файлов MHT со встроенными изображениями в PDF?

О: Да, Aspose.PDF для .NET поддерживает преобразование файлов MHT со встроенными изображениями в PDF. Библиотека может обрабатывать все содержимое веб-страницы, включая изображения и связанные с ними ресурсы, и преобразовывать их в документ PDF.

#### Вопрос. Можно ли настроить вывод PDF в процессе преобразования MHT в PDF?

О: Да, Aspose.PDF для .NET предоставляет различные параметры для настройки вывода PDF в процессе преобразования MHT в PDF. Вы можете установить такие свойства, как размер страницы, ориентация, поля и т. д., чтобы контролировать внешний вид результирующего документа PDF.

#### В: Сохраняет ли Aspose.PDF для .NET гиперссылки и форматирование исходного файла MHT в выводе PDF?

О: Да, Aspose.PDF для .NET сохраняет гиперссылки и форматирование исходного файла MHT в выводе PDF. Библиотека гарантирует, что преобразованный PDF-файл сохранит тот же макет и содержимое, что и исходный файл MHT.

#### В: Могу ли я преобразовать несколько файлов MHT в отдельные документы PDF, используя Aspose.PDF для .NET?

О: Да, вы можете преобразовать несколько файлов MHT в отдельные документы PDF, используя Aspose.PDF для .NET. Просто загрузите каждый файл MHT и сохраните его как отдельный документ PDF с уникальным именем файла.