...
Creamos un objeto Rectángulo con dimensiones especificadas y lo agregamos a la colección de formas del gráfico.
...
Configuramos el relleno de degradado para el rectángulo usando la clase GradientAxialShading.
...
### Código fuente de muestra para agregar un dibujo con relleno degradado usando Aspose.PDF para .NET 
...
En este tutorial, hemos explicado paso a paso cómo agregar un dibujo con un relleno degradado a la programación con gráficos utilizando Aspose.PDF para .NET. Ahora puede utilizar este conocimiento para crear atractivos documentos PDF con diseños personalizados y rellenos degradados.
...
A: El objeto Graph sirve como contenedor de los elementos de dibujo. Se crea con dimensiones específicas y se agrega a la colección de párrafos de la página.

#### P: ¿Cómo puedo configurar el relleno degradado para una forma?

R: Para configurar el relleno con degradado, puede configurar la propiedad FillColor de GraphInfo de una forma mediante la clase GradientAxialShading. Esto le permite definir los puntos de inicio y fin del degradado y los colores entre los que se realizará la transición.

#### P: ¿Puedo personalizar los colores y la dirección del relleno degradado?

R: Sí, puede personalizar los colores y la dirección del relleno de degradado ajustando los objetos de Color y especificando los puntos de inicio y final de GradientAxialShading.

#### P: ¿Cuál es el paso final del tutorial?

R: El paso final implica guardar el archivo PDF resultante con el nombre "AddDrawingWithGradientFill_out.pdf" en el directorio especificado.

#### P: ¿Hay algún código fuente de muestra disponible?

R: Sí, el tutorial proporciona un código fuente de muestra que puedes usar como referencia para implementar los pasos descritos.

#### P: ¿Puedo aplicar relleno degradado a otras formas además de rectángulos?

R: Sí, también puedes aplicar relleno degradado a otras formas. El proceso implica configurar la propiedad FillColor del GraphInfo de la forma mediante la clase GradientAxialShading.