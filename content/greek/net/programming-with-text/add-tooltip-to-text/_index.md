...
## Βήμα 4: Δημιουργήστε ένα δείγμα εγγράφου με κείμενο
 Δημιούργησε ένα νέο`Document` αντικείμενο και προσθήκη σελίδων με θραύσματα κειμένου. Στον παρεχόμενο κώδικα, δύο τμήματα κειμένου προστίθενται στο έγγραφο με το αντίστοιχο κείμενο συμβουλής εργαλείου.
...
Α: Για θραύσματα κειμένου με μεγάλες επεξηγήσεις εργαλείων, επαναλάβετε τα βήματα 5 και 6. Τροποποιήστε ανάλογα τα κριτήρια αναζήτησης και το κείμενο της συμβουλής εργαλείου.
