---
title: Yakınlaştırmayı Devral
linktitle: Yakınlaştırmayı Devral
second_title: Aspose.PDF for .NET API Referansı
description: Aspose.PDF for .NET ile PDF dosyalarınızdaki yer imi yakınlaştırmasını kolayca devralın.
type: docs
weight: 90
url: /tr/net/programming-with-bookmarks/inherit-zoom/
---

Bir PDF belgesindeki yakınlaştırma devralma, yer imleri için varsayılan bir yakınlaştırma düzeyi belirtmenize olanak tanır. Aspose.PDF for .NET ile aşağıdaki kaynak kodunu takip ederek zoom'u kolayca devralabilirsiniz:
