---
title: Page Numberin Header Footer Using Floating Box
linktitle: Page Numberin Header Footer Using Floating Box
second_title: Aspose.PDF for .NET API Reference
description: 
type: docs
weight: 150
url: /net/programming-with-stamps-and-watermarks/page-numberin-header-footer-using-floating-box/
---
