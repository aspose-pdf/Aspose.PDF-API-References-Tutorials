...
// Προσθέστε τον αριθμό της σελίδας στο FloatingBox
...
#### Ε: Πώς μπορώ να καθορίσω τη θέση του FloatingBox στην ενότητα κεφαλίδας ή υποσέλιδου;
 A: Ο παρεχόμενος κωδικός ορίζει τη θέση του FloatingBox χρησιμοποιώντας το`Left` και`Top` σκηνικά θέατρου. Μπορείτε να προσαρμόσετε αυτές τις τιμές για να τοποθετήσετε το FloatingBox όπως επιθυμείτε στην ενότητα κεφαλίδας ή υποσέλιδου.
