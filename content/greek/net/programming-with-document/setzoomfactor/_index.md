...
## Βήμα 4: Αποθηκεύστε το έγγραφο PDF
 ...
 Τέλος, μπορούμε να αποθηκεύσουμε το τροποποιημένο έγγραφο PDF σε νέο αρχείο. Στον παρακάτω κώδικα, αποθηκεύουμε το έγγραφο PDF σε ένα νέο αρχείο με το όνομα "Zoomed_pdf_out.pdf" στο`dataDir` Ευρετήριο.
