...
```
 ...
 Определяя`dataDir`, мы говорим программе, где найти ваш PDF-файл. Это может быть локальный каталог или даже путь к сетевому диску, в зависимости от того, где хранятся ваши файлы.

## Шаг 2: Загрузите PDF-документ

 Теперь, когда мы определили путь к файлу, давайте загрузим PDF-документ в память с помощью Aspose.PDF`Document` объект. Этот объект позволит нам манипулировать PDF-файлом и преобразовывать его в формат изображения.
