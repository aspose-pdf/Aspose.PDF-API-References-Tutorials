...
Αυτή η γραμμή εκτυπώνει ένα μήνυμα επιβεβαίωσης στην κονσόλα. Σας ενημερώνει ότι η σελίδα διαγράφηκε με επιτυχία και δίνει τη θέση του αποθηκευμένου αρχείου PDF. Θεωρήστε το ένα ωραίο μικρό χτύπημα στην πλάτη!
