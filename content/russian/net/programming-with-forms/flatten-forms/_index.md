...
```
 ...
 Здесь мы сохраняем обновленный документ под новым именем,`FlattenForms_out.pdf`Таким образом, мы сохраняем исходный файл нетронутым, создавая новую версию с уплощенными формами.
