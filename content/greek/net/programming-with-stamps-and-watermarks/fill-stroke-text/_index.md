...
#### Ε: Μπορώ να εφαρμόσω χρώματα γεμίσματος και περιγράμματος σε κείμενο που υπάρχει ήδη στο έγγραφο PDF;
 ...
 Α: Ναι, μπορείτε να χρησιμοποιήσετε παρόμοιες αρχές για να εφαρμόσετε χρώματα γεμίσματος και περιγράμματος στο υπάρχον κείμενο στο έγγραφο PDF επιλέγοντας τα κατάλληλα αντικείμενα κειμένου και προσθέτοντάς τα ως σφραγίδες με το επιθυμητό`TextState` ιδιότητες.
