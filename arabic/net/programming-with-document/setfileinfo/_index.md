...
description: تعرف على كيفية استخدام Aspose.PDF for .NET لتعيين معلومات الملف في ملف PDF باستخدام هذا الدليل المفصل خطوة بخطوة.
type: docs
weight: 310
...
### الأسئلة الشائعة حول معلومات الملفات المحددة في ملف PDF

#### س: هل يمكنني تعيين خصائص معلومات ملف إضافية غير مذكورة في المثال؟

 ج: نعم ، يمكنك تعيين خصائص معلومات الملف الإضافية باستخدام امتداد`DocumentInfo` الكائن في Aspose.PDF لـ .NET. ال`DocumentInfo`توفر class خصائص متنوعة تسمح لك بتعيين معلومات إضافية مثل المنتج والإصدار والخصائص المخصصة.

#### س: هل من الممكن استرداد معلومات الملف من مستند PDF موجود؟

 ج: نعم ، يمكنك استرداد معلومات الملف من مستند PDF موجود باستخدام Aspose.PDF for .NET. للقيام بذلك ، يمكنك استخدام ملف`DocumentInfo` كائن للوصول إلى خصائص معلومات الملف وقراءة المعلومات المخزنة في مستند PDF.

#### س: هل يؤدي تعيين معلومات الملف إلى تعديل مستند PDF الأصلي؟

ج: لا ، لا يؤدي تعيين معلومات الملف باستخدام Aspose.PDF for .NET إلى تعديل مستند PDF الأصلي. بدلاً من ذلك ، يقوم بإنشاء مستند PDF جديد بمعلومات الملف المحدثة. يظل مستند PDF الأصلي بدون تغيير.