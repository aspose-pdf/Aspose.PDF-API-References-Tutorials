...
В этом руководстве мы объяснили пошаговый процесс добавления таблицы в документ PDF с помощью Aspose.PDF для .NET. Мы рассмотрели загрузку исходного PDF-документа, инициализацию нового экземпляра класса Table, настройку цвета границы таблицы и границ ячеек, добавление строк и ячеек в таблицу и добавление объекта таблицы в документ. Следуя этому руководству, вы сможете легко программно включать таблицы в свои PDF-документы и настраивать их в соответствии со своими конкретными потребностями.