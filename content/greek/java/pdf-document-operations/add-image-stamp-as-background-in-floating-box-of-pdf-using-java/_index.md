...
## Προσθήκη σφραγίδας εικόνας
 ...
 Στη συνέχεια, θα προσθέσουμε μια σφραγίδα εικόνας στο έγγραφο PDF. Θα πρέπει να έχετε έτοιμο το αρχείο εικόνας σας για αυτό το βήμα. Θα χρησιμοποιήσουμε το`addStamp` μέθοδος προσθήκης της εικόνας ως σφραγίδα.
