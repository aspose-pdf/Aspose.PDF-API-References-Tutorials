...
description: Easily add an image to a PDF document using Aspose.PDF for .NET.
type: docs
weight: 10
url: /content/net/programming-with-images/add-image/
---

This guide will take you step by step how to add an image to a PDF document using Aspose.PDF for .NET. Make sure you have already set up your environment and follow the steps below:
