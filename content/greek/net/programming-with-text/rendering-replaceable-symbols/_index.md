...
---
Σε αυτό το σεμινάριο, θα εξηγήσουμε πώς να αποδώσετε αντικαταστάσιμα σύμβολα σε αρχείο PDF χρησιμοποιώντας τη βιβλιοθήκη Aspose.PDF για .NET. Θα ακολουθήσουμε τη διαδικασία βήμα προς βήμα δημιουργίας ενός PDF, προσθήκης ενός τμήματος κειμένου με δείκτες νέας γραμμής, ορισμού ιδιοτήτων κειμένου, τοποθέτησης του κειμένου και αποθήκευσης του PDF χρησιμοποιώντας τον παρεχόμενο πηγαίο κώδικα C#.
...
3.  Δημιουργία α`TextFragment` αντικείμενο με δείκτες νέας γραμμής (`Environment.NewLine`) για την αναπαράσταση περιεχομένου πολλών γραμμών.
...
5.  Δημιουργία α`TextParagraph` αντικείμενο, προσθέστε το τμήμα κειμένου σε αυτό και ορίστε τη θέση της παραγράφου στη σελίδα.
6.  Δημιουργία α`TextBuilder` αντικείμενο με τη σελίδα και προσθέστε την παράγραφο κειμένου σε αυτήν.
