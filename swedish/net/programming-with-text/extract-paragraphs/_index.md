---
title: Extrahera stycken
linktitle: Extrahera stycken
second_title: Aspose.PDF för .NET API Referens
description: Lär dig hur du extraherar stycken från ett PDF-dokument med Aspose.PDF för .NET.
type: docs
weight: 160
url: /sv/net/programming-with-text/extract-paragraphs/
---

Denna handledning guidar dig genom processen att extrahera stycken från ett PDF-dokument med Aspose.PDF för .NET. Den medföljande C#-källkoden visar de nödvändiga stegen.
