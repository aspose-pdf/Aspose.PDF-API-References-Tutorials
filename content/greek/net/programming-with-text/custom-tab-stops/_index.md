...
## Βήμα 6: Δημιουργήστε προσαρμοσμένες στάσεις καρτελών
 Δημιουργώ ένα`TabStops` αντικείμενο και προσθέστε προσαρμοσμένες στάσεις καρτελών σε αυτό. Ορίστε τον τύπο στοίχισης και τον τύπο του οδηγού για κάθε στοπ καρτέλας.
