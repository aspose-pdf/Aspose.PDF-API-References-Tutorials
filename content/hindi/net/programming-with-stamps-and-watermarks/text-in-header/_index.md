---
title: पीडीएफ फाइल के हेडर में टेक्स्ट
linktitle: पीडीएफ फाइल के हेडर में टेक्स्ट
second_title: .NET API संदर्भ के लिए Aspose.PDF
description: .NET के लिए Aspose.PDF के साथ PDF फ़ाइल के हेडर में टेक्स्ट जोड़ने का तरीका जानें।
type: docs
weight: 190
...
#### प्रश्न: क्या मैं हेडर टेक्स्ट का स्वरूप, जैसे उसका फ़ॉन्ट, आकार, रंग और संरेखण संशोधित कर सकता हूँ?
 ...
 उत्तर: हां, आप हेडर टेक्स्ट के गुणों को संशोधित करके उसके स्वरूप को अनुकूलित कर सकते हैं`TextStamp`वस्तु। कोड उदाहरण में शीर्ष मार्जिन, क्षैतिज संरेखण और ऊर्ध्वाधर संरेखण जैसे सेटिंग गुण शामिल हैं। आप फ़ॉन्ट, आकार, रंग और अन्य पाठ-संबंधित गुणों को भी समायोजित कर सकते हैं।

#### प्रश्न: क्या प्रत्येक पृष्ठ के शीर्षलेख में अलग-अलग पाठ जोड़ना संभव है?

 उ: हाँ, आप प्रत्येक पृष्ठ के हेडर में अलग-अलग टेक्स्ट बनाकर जोड़ सकते हैं`TextStamp` विभिन्न पाठ्य सामग्री या गुणों वाली वस्तुओं और फिर उन्हें आवश्यकतानुसार विशिष्ट पृष्ठों में जोड़ना।
