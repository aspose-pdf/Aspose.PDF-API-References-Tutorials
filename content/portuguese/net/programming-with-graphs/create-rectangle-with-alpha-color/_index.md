...
description: Aprenda a criar um retângulo com cor transparente usando o Aspose.PDF para .NET. Guia passo a passo para personalizar a transparência.
type: docs
weight: 60
url: /pt/net/programming-with-graphs/create-rectangle-with-alpha-color/
---
Neste tutorial, mostraremos passo a passo o seguinte código-fonte em C# para criar um retângulo com cor alfa usando Aspose.PDF para .NET.
...
Criamos um objeto Graph com dimensões especificadas e um retângulo com dimensões específicas.
...
## Etapa 4: Configurando a cor alfa para o retângulo
...
## Etapa 7: Adicionando o objeto Graph à página
...
Por fim, salvamos o arquivo PDF resultante com o nome "CreateRectangleWithAlphaColor_out.pdf" no diretório especificado.

```csharp
doc.Save(dataDir + "CreateRectangleWithAlphaColor_out.pdf");
```

### Código-fonte de exemplo para criar retângulo com cor alfa usando Aspose.PDF para .NET 
...
Neste tutorial, explicamos como criar um retângulo com cor alfa usando o Aspose.PDF para .NET. Agora você pode usar esse conhecimento para criar formas geométricas com cores transparentes em seus arquivos PDF.

## Perguntas frequentes

#### P: Qual é o propósito deste tutorial?

R: Este tutorial tem como objetivo guiá-lo pelo processo de criação de um retângulo com cor alfa usando o Aspose.PDF para .NET. Você aprenderá como adicionar formas geométricas com cores transparentes aos seus arquivos PDF.
...
#### P: Qual é o propósito do objeto Graph e Rectangle?

R: O objeto Gráfico atua como um contêiner para elementos de desenho, enquanto o Retângulo representa a forma geométrica que você adicionará ao PDF.
...
R: Sim, você pode criar vários retângulos com diferentes cores alfa seguindo etapas semelhantes às demonstradas no tutorial.

#### P: Como faço para salvar o arquivo PDF resultante depois de criar retângulos com cores alfa?
