...
description: Guía paso a paso para usar operadores de PDF con Aspose.PDF para .NET. Agregue una imagen a una página PDF y especifique su posición.
type: docs
weight: 20
url: /es/net/programming-with-operators/pdf-operators/
---
En este tutorial, le proporcionaremos una guía paso a paso sobre cómo usar operadores de PDF usando Aspose.PDF para .NET. Los operadores de PDF le permiten manipular y agregar contenido a documentos PDF de forma precisa y controlada. Con los operadores proporcionados por Aspose.PDF, puede agregar una imagen a una página PDF y especificar su posición con precisión.
...
Use el siguiente código para cargar una imagen desde un archivo y agregarla a la página PDF:
