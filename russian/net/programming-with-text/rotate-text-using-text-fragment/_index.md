---
title: Поворот текста с помощью текстового фрагмента
linktitle: Поворот текста с помощью текстового фрагмента
second_title: Aspose.PDF для справочника API .NET
description: Узнайте, как повернуть текст, используя текстовые фрагменты в документе PDF, используя Aspose.PDF для .NET.
type: docs
weight: 390
url: /ru/net/programming-with-text/rotate-text-using-text-fragment/
---

В этом руководстве объясняется, как использовать Aspose.PDF для .NET для поворота текста с использованием текстовых фрагментов. Предоставленный исходный код C# демонстрирует пошаговый процесс.
...
Отрегулируйте текст, позиции и другие свойства по желанию.

## Шаг 6: Создайте TextBuilder и добавьте текстовые фрагменты

 Создать`TextBuilder` объект с помощью`pdfPage` и добавьте текстовые фрагменты на страницу PDF:
...
Поздравляем! Вы успешно научились поворачивать текст, используя текстовые фрагменты в документе PDF, используя Aspose.PDF для .NET. В этом руководстве представлено пошаговое руководство от создания документа до сохранения измененной версии. Теперь вы можете включить этот код в свои собственные проекты C# для управления поворотом текста в файлах PDF.