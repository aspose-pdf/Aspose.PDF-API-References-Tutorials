---
title: Applica stile numero
linktitle: Applica stile numero
second_title: Aspose.PDF per riferimento API .NET
description: Scopri come applicare uno stile di numerazione alle intestazioni in un documento PDF utilizzando Aspose.PDF per .NET. Guida passo passo.
type: docs
weight: 10
url: /it/net/programming-with-headings/apply-number-style/
---
In questo tutorial, ti guideremo attraverso il seguente codice sorgente C# passo dopo passo per applicare lo stile di numerazione usando Aspose.PDF per .NET.
