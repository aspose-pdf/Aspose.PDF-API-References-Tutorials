...
Εδώ, ορίσαμε το μέγεθος της σελίδας σε 1000x1000 pixel. Μπορείτε να προσαρμόσετε τις διαστάσεις σύμφωνα με τις απαιτήσεις σας.
 3. Χρησιμοποιήστε το`PdfProducer.Produce` μέθοδος μετατροπής του αρχείου CGM σε μορφή PDF.
```csharp
...
Α: Η μετατροπή μιας μεγάλης εικόνας CGM σε PDF διασφαλίζει ότι η εικόνα διατηρείται σε μια ευρέως αναγνωρισμένη μορφή που μπορεί εύκολα να κοινοποιηθεί, να προβληθεί και να αρχειοθετηθεί σε διαφορετικές πλατφόρμες και συσκευές.