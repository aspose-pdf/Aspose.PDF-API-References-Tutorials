...
R : À l'aide d'Aspose.PDF pour .NET, vous pouvez récupérer diverses propriétés de fenêtre d'un document PDF, notamment le centrage de la fenêtre, la définition de la mise en page, le contrôle de l'affichage des barres d'outils et des barres de menus, etc.