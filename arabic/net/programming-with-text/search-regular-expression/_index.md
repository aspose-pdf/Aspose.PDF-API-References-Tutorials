---
title: البحث في التعبير العادي
linktitle: البحث في التعبير العادي
second_title: Aspose.PDF لمرجع .NET API
description: تعرف على كيفية البحث عن النص واسترداده باستخدام التعبيرات العادية في مستند PDF باستخدام Aspose.PDF for .NET.
type: docs
weight: 440
url: /ar/net/programming-with-text/search-regular-expression/
---

يشرح هذا البرنامج التعليمي كيفية استخدام Aspose.PDF لـ .NET للبحث عن النص الذي يطابق تعبيرًا عاديًا في مستند PDF واسترداده. يوضح كود المصدر C # المقدم العملية خطوة بخطوة.
...
## الخطوة 4: البحث باستخدام التعبير العادي
 ...
 إنشاء`TextFragmentAbsorber` كائن وتعيين نمط التعبير العادي للعثور على جميع العبارات التي تطابق النمط:
...
## الخطوة 5: تعيين خيارات البحث عن النص

 إنشاء`TextSearchOptions` كائن وضبطه على`TextSearchOptions` ممتلكات`TextFragmentAbsorber` كائن لتمكين استخدام التعبير العادي:
...
## الخطوة 7: استرجاع أجزاء النص المستخرجة
...
## الخطوة 8: التكرار خلال أجزاء النص

التكرار خلال أجزاء النص المسترجعة والوصول إلى خصائصها:
...
### نموذج التعليمات البرمجية المصدر للبحث عن التعبير العادي باستخدام Aspose.PDF for .NET 
```csharp
...
تهانينا! لقد تعلمت بنجاح كيفية البحث عن النص الذي يطابق تعبيرًا عاديًا في مستند PDF واسترداده باستخدام Aspose.PDF لـ .NET. قدم هذا البرنامج التعليمي دليلاً خطوة بخطوة ، من تحميل المستند إلى الوصول إلى أجزاء النص المستخرجة. يمكنك الآن دمج هذا الرمز في مشاريع C # الخاصة بك لإجراء عمليات بحث نصية متقدمة في ملفات PDF.