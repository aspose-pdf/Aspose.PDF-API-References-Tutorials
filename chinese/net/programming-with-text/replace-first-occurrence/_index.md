...
我们创造一个`TextFragmentAbsorber`反对并接受 PDF 文档的所有页面以查找搜索短语的所有实例。
...
### 使用 Aspose.PDF for .NET 替换第一次出现的示例源代码 
```csharp
//文档目录的路径。
string dataDir = "YOUR DOCUMENT DIRECTORY";
//打开文档
...
在本教程中，您学习了如何使用 .NET 的 Aspose.PDF 库替换 PDF 文档中第一次出现的特定文本。按照分步指南并执行提供的 C# 代码，您可以打开 PDF 文档、查找第一次出现的搜索短语、替换文本、更新属性并保存修改后的 PDF。