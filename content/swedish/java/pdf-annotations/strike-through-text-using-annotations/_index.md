...
### Hur ändrar jag färgen på den genomstrukna kommentaren?
 ...
 För att ändra färgen på den genomstrukna annoteringen kan du använda`setColor` metod och ange önskad färg. I exemplet ställde vi in det på rött med hjälp av`setColor(com.aspose.pdf.Color.getRed())`.
