...
## Βήμα 5: Εξαγωγή κειμένου χρησιμοποιώντας τη συσκευή κειμένου
 Δημιουργία α`StringBuilder` αντικείμενο για να κρατήσει το εξαγόμενο κείμενο. Επαναλάβετε σε κάθε σελίδα του εγγράφου και χρησιμοποιήστε a`TextDevice` για να εξαγάγετε το κείμενο από κάθε σελίδα.
