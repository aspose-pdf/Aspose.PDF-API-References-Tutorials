...
В этом руководстве вы узнали, как удалить весь текст из документа PDF с помощью библиотеки Aspose.PDF для .NET. Следуя пошаговому руководству и выполняя предоставленный код C#, вы можете открыть PDF-файл, выбрать и удалить текст на каждой странице и сохранить измененный PDF-файл.