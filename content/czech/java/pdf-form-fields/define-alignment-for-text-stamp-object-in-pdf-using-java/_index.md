...
Ano, Aspose.PDF for Java nabízí pokročilé možnosti zarovnání, včetně vystředění textových razítek vodorovně i svisle, zarovnání podle konkrétních okrajů a další. Podrobné příklady najdete v dokumentaci.