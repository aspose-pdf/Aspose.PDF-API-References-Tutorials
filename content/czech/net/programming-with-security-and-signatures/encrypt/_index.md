...
## Krok 2: Nastavte cestu ke složce dokumentů
 ...
 V tomto kroku musíte zadat cestu ke složce obsahující soubor PDF, který má být zašifrován. Nahradit`"YOUR DOCUMENTS DIRECTORY"` následujícím kódu se skutečnou cestou ke složce dokumentů:
