...
本教程解释了如何使用 Aspose.PDF for .NET 从 PDF 文档的特定页面中搜索和获取文本。提供的 C# 源代码逐步演示了该过程。
...
创建一个`TextFragmentAbsorber`对象以在特定页面上查找输入搜索短语的所有实例：

```csharp
TextFragmentAbsorber textFragmentAbsorber = new TextFragmentAbsorber("Figure");
```

代替`"Figure"`使用您要搜索的实际文本。
...
恭喜！您已经成功学习了如何使用 Aspose.PDF for .NET 从 PDF 文档的特定页面搜索和获取文本。本教程提供了从加载文档到访问提取的文本片段的分步指南。您现在可以合并