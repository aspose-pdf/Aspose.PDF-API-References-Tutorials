...
| [Προσθήκη ετικέτας εικόνας σε υπάρχον PDF](./tag-image-in-existing-pdf/) | Μάθετε πώς να επισημαίνετε μια εικόνα σε ένα υπάρχον PDF με το Aspose.PDF για .NET. Ένας οδηγός βήμα προς βήμα για την προσθήκη ετικετών σε εικόνες. |  
