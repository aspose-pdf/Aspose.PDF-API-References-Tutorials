...
description: 了解如何使用 Aspose.PDF for .NET 使用 PDF 文档中的文本片段旋转文本。
type: docs
weight: 390
url: /zh/net/programming-with-text/rotate-text-using-text-fragment/
---

本教程解释了如何使用 Aspose.PDF for .NET 使用文本片段来旋转文本。提供的 C# 源代码逐步演示了该过程。
...
## 第 6 步：创建一个 TextBuilder 并附加文本片段
...
恭喜！您已经成功学习了如何使用 Aspose.PDF for .NET 在 PDF 文档中使用文本片段来旋转文本。本教程提供了从创建文档到保存修改后版本的分步指南。您现在可以将此代码合并到您自己的 C# 项目中，以操作 PDF 文件中的文本旋转。