...
Αυτό το απόσπασμα κώδικα φορτώνει ένα έγγραφο XPS και το αποθηκεύει ως αρχείο PDF. Φροντίστε να αντικαταστήσετε το "input.xps" με τη διαδρομή προς το αρχείο XPS και το "output.pdf" με το όνομα του επιθυμητού αρχείου PDF.
