...
description: Узнайте, как определить разрывы таблиц в PDF-файле с помощью Aspose.PDF для .NET.
type: docs
weight: 60
...
#### В: Как настроить верхнее поле таблицы?
 ...
 A: В предоставленном исходном коде C# вы можете настроить верхнее поле таблицы, изменив значение`table1.Margin.Top`свойство. Увеличьте или уменьшите значение по мере необходимости, чтобы задать желаемое верхнее поле для таблицы.
