...
इस चरण में, हम इसका उपयोग करके पीडीएफ दस्तावेज़ खोलेंगे`Document` Aspose.PDF की कक्षा।
...
## चरण 3: टेक्स्ट फ़ील्ड बनाना
 ...
 हम इसका उपयोग करके एक टेक्स्ट फ़ील्ड बनाएंगे`TextBoxField` कक्षा। आप इसका उपयोग करके स्थिति निर्देशांक और फ़ील्ड आकार निर्दिष्ट कर सकते हैं`Rectangle` कक्षा।
...
## चरण 6: संशोधित पीडीएफ को सहेजना
 ...
 अंत में, हम इसका उपयोग करके संशोधित पीडीएफ को सहेज सकते हैं`Save` की विधि`Document` कक्षा।
